...
def create_app():
    ...
    if not _secret_key or _secret_key == 'change-me-to-a-secure-key':
        import warnings
        warnings.warn(
        ...
        # Fall back so the app can still start in development
        _secret_key = _secret_key or 'change-me-to-a-secure-key'
    ...
    app.config['MODEL_NAME_1'] = resolve_env_value('MODEL_NAME_1', 'glm-4.5-air')
    ...
    app.config['MODEL_NAME_2'] = resolve_env_value('MODEL_NAME_2', 'glm-4.5-air')
